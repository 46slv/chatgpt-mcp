...
# Persist host evidence as BOM-free UTF-8 and fail closed on invalid UTF-16
# input (for example an unpaired surrogate) so the writer cannot silently
# replacement-encode text that the strict Node verifier would later accept.
